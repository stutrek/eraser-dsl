...
let services: ReturnType<typeof createEraserServices>;
type ParseHelperT<T> = typeof parseHelper;
let parse: ReturnType<ParseHelperT<Model>>;
let document: LangiumDocument<Model> | undefined;

beforeAll(async () => {
  services = createEraserServices(EmptyFileSystem);
  const doParse = parseHelper<Model>(services.Eraser);
